`ifndef SDP_TO_HSL_CFG__SV
`define SDP_TO_HSL_CFG__SV

class sdp_to_hsl_cfg extends uvm_object; 
   ...
   `uvm_object_utils_begin(sdp_to_hsl_cfg)
...
endclass: sdp_to_hsl_cfg

`endif // SDP_TO_HSL_CFG__SV
