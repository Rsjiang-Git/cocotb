`ifndef TYPICAL_ENV_CFG__SV
`define TYPICAL_ENV_CFG__SV

class typical_env_cfg extends uvm_object; 
  ...
  `uvm_object_param_utils_begin(typical_env_cfg)
...
endclass: typical_env_cfg

`endif // TYPICAL_ENV_CFG__SV
