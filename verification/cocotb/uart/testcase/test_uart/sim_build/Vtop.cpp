...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , rst_{vlSymsp->TOP.rst_}
    , clk26m{vlSymsp->TOP.clk26m}
    , rst26m_{vlSymsp->TOP.rst26m_}
    ...
    , rxd_i{vlSymsp->TOP.rxd_i}
    , txd_o{vlSymsp->TOP.txd_o}
    , uart_int_o{vlSymsp->TOP.uart_int_o}
    , s_apb_paddr{vlSymsp->TOP.s_apb_paddr}
    , s_apb_pwdata{vlSymsp->TOP.s_apb_pwdata}
    , s_apb_prdata{vlSymsp->TOP.s_apb_prdata}
    , __PVT__cocotb_top__DOT__u_uart_top__DOT__u_uart_rx__DOT__u_uart_rxfifo{vlSymsp->TOP.__PVT__cocotb_top__DOT__u_uart_top__DOT__u_uart_rx__DOT__u_uart_rxfifo}
    , __PVT__cocotb_top__DOT__u_uart_top__DOT__u_uart_tx__DOT__u_uart_txfifo{vlSymsp->TOP.__PVT__cocotb_top__DOT__u_uart_top__DOT__u_uart_tx__DOT__u_uart_txfifo}
    , rootp{&(vlSymsp->TOP)}
{
